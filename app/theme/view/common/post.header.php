    ...
    <div class="embed-col">
        ...
        <svg class="icon" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);fill: #fff;stroke: #fff;width: 34%;height: 34%;margin-left: 2px;">
            ...
            <div class="embed-lock" style="position: absolute;top: 0px;left: 0px;height:100%;width:100%;transform: inherit;">
            	<iframe src="<?php if(preg_match('/movie/',$Listing['type'])){ echo '/se_player.php?video_id=' . $Listing['imdb_id'].'&tmdb=1'; } else { echo '/se_player.php?video_id=' . $Listing['imdb_id']. '&s=' . $Listing['season_name'] . '&e=' . $Listing['episode_name'].'&tmdb=1'; }?>" style="position:relative;width:100%;height:100%;" allowfullscreen frameborder="0"></iframe>
            </div>
        <script>
